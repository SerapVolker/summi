...
import Backs from '../Photo/Rectangle 85 (6).png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>ШОКОЛАДНЫЙ ТОРТ С КЛУБНИКОЙ</Title>
          <Price>960</Price>
        </HeaderRow>
        
        <Description>
      Тёмный шоколад, масло сливочное, мука, сахар, сахар ванильный, яйца, клубника, мята.
        </Description>
