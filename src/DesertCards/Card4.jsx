...
import Backs from '../Photo/Rectangle 85 (9).png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>ПАРФЕ С СОУСОМ ИЗ ЛЕСНЫХ ЯГОД</Title>
          <Price>920</Price>
        </HeaderRow>
        
        <Description>яйца, ликер “Амаретто”, сахарная пудра, ягоды, сахар, печенье бисквитное.
        </Description>
