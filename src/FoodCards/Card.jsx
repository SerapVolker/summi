...
import Backs from '../Photo/Rectangle 85.png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>СТЕЙК ПОРТЕРХАУС</Title>
          <Price>1450</Price>
        </HeaderRow>
        
        <Description>
        Говядина, чеснок, укроп, петрушка, кинза, лайм, чили перец, размарин, тимьян.
        </Description>
        ...
        <Specs>
          ...
          <SpecItem>🥩 мраморность 5+</SpecItem>
        </Specs>
      </Content>
    </CardContainer>
  );
