...
import Backs from '../Photo/Rectangle 85 (1).png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>ТРЕСКА С ГРИБНЫМ СОУСОМ</Title>
          <Price>1750</Price>
        </HeaderRow>
        
        <Description>
 Треска, грибы намеко, лук, чеснок, соус мирин, соевый соус, сычуанский соус, масло.
        </Description>
