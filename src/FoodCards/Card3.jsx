...
import Backs from '../Photo/Rectangle 85 (3).png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>РИЗОТТО С ТАРТАРОМ  </Title>
          <Price>1350</Price>
        </HeaderRow>
        
        <Description>
Рис, креветки, лук-шалот, белое вино, рыбный бульон, сливочное масло, пармезан, сырые фисташки
        </Description>
