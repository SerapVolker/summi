...
import Backs from '../Photo/Rectangle 85 (4).png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>НЬОККИ С РИКОТТОЙ И СОУСОМ</Title>
          <Price>1980</Price>
        </HeaderRow>
        
        <Description>
        Рикотта, яйцо, пармезан, соль, базилик, томато пелати, чеснок, оливковое масло, перец чили.
        </Description>
