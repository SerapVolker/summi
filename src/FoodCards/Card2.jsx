...
import Backs from '../Photo/Rectangle 85 (2).png';
...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <HeaderRow>
          <Title>ПЕТТО ДЕНАТРА</Title>
          <Price>2450</Price>
        </HeaderRow>
        
        <Description>
    Утиная грудка, яблоко, сахар, сливочное масло, мята, чеснок, клюква, оливковое масло, базилик, корица, кардамон, гвоздика,  красное сухое вино. 
        </Description>
